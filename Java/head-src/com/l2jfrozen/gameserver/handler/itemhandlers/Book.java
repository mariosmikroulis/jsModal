...
public class Book implements IItemHandler
{
	...
	private static final String[] _bookMenu =
	{
		"npc_%objectId%_Chat 1",
		"npc_%objectId%_Chat 2",
		"npc_%objectId%_Chat 3",    
		"npc_%objectId%_Chat 4",
		"npc_%objectId%_Chat 5",
	};
	...
	public void useItem(final L2PlayableInstance playable, final L2ItemInstance item)
	{
		...
		if(itemId == 5588)
		{
			locationHTM = "data/html/merchant/6666.htm";
		}
		else
		{
			locationHTM = "data/html/help/" + itemId + ".htm";
		}
		
		String filename = locationHTM;
