...
public final class RequestPrivateStoreBuy extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.TRADE_DROP_PICK_BUY_SELL_ENABLED && Config.BUY_TIME_DISABLE!=0 && Config.BUY_TIME_DISABLE > player.getOnlineTime())
		{
			player.sendMessage("You are in Buy Protection Mode for the next " + Config.BUY_TIME_TEXT + " since you have created this char. We apologise for that but it is kind of our own protection.");
			return;
		}
		
		else if (storeList.getItemCount() == 0)
		{
