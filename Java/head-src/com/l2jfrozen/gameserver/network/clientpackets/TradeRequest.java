...
public final class TradeRequest extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.TRADE_DROP_PICK_BUY_SELL_ENABLED && Config.TRADE_TIME_DISABLE!=0 && player.getOnlineTime() < Config.TRADE_TIME_DISABLE)
		{
			player.sendMessage("You are in Trade Protection Mode for the next " + Config.TRADE_TIME_TEXT + " since you have created this char. We apologise for that but it is kind of our own protection. If you believe that you are longer than that time, please restart your character now!");
			player.sendMessage("If the problem still remains, try to type .menu and then disable the protection from there otherwise contact without team.");
			player.sendPacket(ActionFailed.STATIC_PACKET);
			return;
		}
