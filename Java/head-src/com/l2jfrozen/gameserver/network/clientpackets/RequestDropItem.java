...
public final class RequestDropItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.TRADE_DROP_PICK_BUY_SELL_ENABLED && activeChar.getOnlineTime() < Config.DROP_TIME_DISABLE && Config.DROP_TIME_DISABLE!=0)
		{
			activeChar.sendMessage("You are in Drop Protection Mode for the next " + Config.DROP_TIME_TEXT + " since you have created this char. We apologise for that but it is kind of our own protection. If you believe that you are longer than that time, please restart your character now!");
			return;
		}
