...
public class Shutdown extends Thread
{
	...
	public void startTelnetShutdown(final String IP, final int seconds, final boolean restart)
	{
		...
		_an.announceToAll(Config.SERVERNAME+" is " + MODE_TEXT[_shutdownMode] + " in " + seconds + " seconds!");
	...
	public void telnetAbort(final String IP)
	{
		...
		_an.announceToAll(Config.SERVERNAME+" aborts " + MODE_TEXT[_shutdownMode] + " and continues normal operation!");
		_an = null;
	...
	private void closeServer()
	{
		...
		LOGGER.info("[STATUS] "+Config.SERVERNAME + " shutdown successfully.");
	...
	private synchronized void saveData()
	{
		...
		try
		{
			_an.announceToAll(Config.SERVERNAME+" is " + MODE_TEXT[_shutdownMode] + " NOW!");
			_an = null;
		}
		catch (final Throwable t)
		{
