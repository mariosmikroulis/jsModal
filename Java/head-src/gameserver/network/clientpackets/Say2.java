...
import com.l2jfrozen.gameserver.handler.usercommandhandlers.L2Towel;
...
public final class Say2 extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(_text.equalsIgnoreCase("//cfg") || _text.equalsIgnoreCase("/cfg"))
		{
			L2Towel.mainHtml(activeChar);
		}
