...
import com.l2jfrozen.gameserver.handler.voicedcommandhandlers.ServerInfo;
import com.l2jfrozen.gameserver.handler.voicedcommandhandlers.Survey;
...
import com.l2jfrozen.gameserver.handler.voicedcommandhandlers.VoteRewardMe;
...
public class VoicedCommandHandler
{
	...
	private VoicedCommandHandler()
	{
		...
		if (Config.MENU_COMMAND_ENABLED)
		...
		if(Config.CLANREGISTERTOCASTLE)
		{
		...
		{
			registerVoicedCommandHandler( new VoteRewardMe());
		}
		...
		if (Config.SERVER_INFO_COMMAND_ENABLE)
		{
