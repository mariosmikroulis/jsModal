...
public class Continuous implements ISkillHandler
{
	...
	public void useSkill(final L2Character activeChar, L2Skill skill2, final L2Object[] targets)
	{
		...
		for (final L2Object target2 : targets)
		{
			...
			if (activeChar instanceof L2PcInstance && target != activeChar && target.isBuffProtected() && !skill.isHeroSkill() && (skill.getSkillType() == L2Skill.SkillType.BUFF || skill.getSkillType() == L2Skill.SkillType.HEAL_PERCENT|| skill.getSkillType() == L2Skill.SkillType.MANAHEAL_PERCENT|| skill.getSkillType() == L2Skill.SkillType.COMBATPOINTHEAL|| skill.getSkillType() == L2Skill.SkillType.REFLECT))
			continue;
