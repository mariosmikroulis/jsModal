...
public class AdminSurvey implements IAdminCommandHandler
{
       ...
       {
               "admin_survey_start" , "admin_survey_results" , "admin_opmore" , "admin_opless" , "admin_survey_run1","admin_survey_run2","admin_survey_run3","admin_survey_run4", "admin_survey_qset",
               "admin_survey_ans1set", "admin_survey_ans2set","admin_survey_ans3set","admin_survey_ans4set","admin_survey_ans5set", "admin_survey_end"
       };
