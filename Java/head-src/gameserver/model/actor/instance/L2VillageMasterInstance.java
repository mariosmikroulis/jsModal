...
public final class L2VillageMasterInstance extends L2FolkInstance
{
	...
	public void onBypassFeedback(final L2PcInstance player, final String command)
	{
		...
		else if (command.startsWith("Subclass"))
		{
			...
			TextBuilder content = new TextBuilder("<html><title>L2Submission!</title><body><center><br><font color=\"003366\" align=\"center\">___________________________________________</font><img src=L2Submission.classmanager height=90 width=256><br1><font color=\"003366\" align=\"center\">___________________________________________</font></center><br1>");
			...
			switch (cmdChoice)
			{
				case 1: // Add Subclass - Initial
					...
					if (subsAvailable != null && !subsAvailable.isEmpty())
					{
						...
						{
							content.append("<button width=\"256\" height=\"21\" back=\"L2Submission.button2\" fore=\"L2Submission.button1\" action=\"bypass -h npc_" + getObjectId() + "_Subclass 4 " + subClass.ordinal() + "\" msg=\"1268;" + formatClassForDisplay(subClass) + "\" value=\"" + formatClassForDisplay(subClass) + "\"><br>");
						}
					}
					else
					{
				...
				case 2: // Change Class - Initial
					...
					{
						content.append("You can't change sub classes when you don't have a sub class to begin with.<br>" + "<button width=\"256\" height=\"21\" back=\"L2Submission.button2\" fore=\"L2Submission.button1\" action=\"bypass -h npc_" + getObjectId() + "_Subclass 1\" value=\"Add subclass.\">");
					}
					else
					{
						...
						{
							content.append("<button width=\"256\" height=\"21\" back=\"L2Submission.button2\" fore=\"L2Submission.button1\" action=\"bypass -h npc_" + getObjectId() + "_Subclass 5 0\" value=\"" + CharTemplateTable.getClassNameById(baseClassId) + "\">&nbsp;" + "<font color=\"LEVEL\">(Base Class)</font><br><br>");
						}
						...
						for (final Iterator<SubClass> subList = iterSubClasses(player); subList.hasNext();)
						{
							...
							{
								content.append("<button width=\"256\" height=\"21\" back=\"L2Submission.button2\" fore=\"L2Submission.button1\" action=\"bypass -h npc_" + getObjectId() + "_Subclass 5 " + subClass.getClassIndex() + "\" value=\"" + CharTemplateTable.getClassNameById(subClassId) + "\"><br>");
							}
						}
					}
					break;
				case 3: // Change/Cancel Subclass - Initial
					...
					for (final Iterator<SubClass> subList = iterSubClasses(player); subList.hasNext();)
					{
						...
						content.append("<button width=\"256\" height=\"21\" back=\"L2Submission.button2\" fore=\"L2Submission.button1\" action=\"bypass -h npc_" + getObjectId() + "_Subclass 6 " + subClass.getClassIndex() + "\" value=\"" + CharTemplateTable.getClassNameById(subClass.getClassId()) + "\"><br>");
				...
				case 6: // Change/Cancel Subclass - Choice
					...
					if (subsAvailable != null && !subsAvailable.isEmpty())
					{
						for (final PlayerClass subClass : subsAvailable)
						{
							content.append("<button width=75 height=21 back=\"L2Submission.button2\" fore=\"L2Submission.button1\" align=\"center\" action=\"bypass -h npc_" + getObjectId() + "_Subclass 7 " + paramOne + " " + subClass.ordinal() + "\" value=\"" + formatClassForDisplay(subClass) + "\"><br>");
						}
					}
					else
					{
