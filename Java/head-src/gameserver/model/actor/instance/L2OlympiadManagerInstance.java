...
public class L2OlympiadManagerInstance extends L2FolkInstance
{
	...
	public void onBypassFeedback(final L2PcInstance player, final String command)
	{
		...
		else if (command.startsWith("OlympiadNoble"))
		{
			...
			switch (val)
			{
				...
				case 2:
					...
					replyMSG = new TextBuilder("<html><title>L2Submission PvP Server!</title><br><center><font color=\"003366\" align=\"center\">___________________________________________</font><img src=\"L2Submission.gom\" width=\"256\" height=\"256\"><font color=\"003366\" align=\"center\">___________________________________________</font><br><br>");
					replyMSG.append("The number of people on the waiting list for " + "Grand Olympiad" + "<center>" + "<img src=\"L2UI.SquareWhite\" width=270 height=1><img src=\"L2UI.SquareBlank\" width=1 height=3>" + "<table width=270 border=0 bgcolor=\"000000\">" + "<tr>" + "<td align=\"left\">General</td>" + "<td align=\"right\">" + classed + "</td>" + "</tr>" + "<tr>" + "<td align=\"left\">Not class-defined</td>" + "<td align=\"right\">" + nonClassed + "</td>" + "</tr>" + "</table><br>" + "<img src=\"L2UI.SquareWhite\" width=270 height=1> <img src=\"L2UI.SquareBlank\" width=1 height=3>" + "<button value=\"Back\" action=\"bypass -h npc_" + getObjectId() + "_OlympiadDesc 2a\" " + "width=40 height=15 back=\"L2Submission.button2\" fore=\"L2Submission.button1\"></center>");
				...
				case 3:
					...
					{
						reply = new NpcHtmlMessage(getObjectId());
						replyMSG = new TextBuilder("<html><title>L2Submission!</title><body><center><br><font color=\"003366\" align=\"center\">___________________________________________</font><img src=L2Submission.gom height=90 width=256><br1><font color=\"003366\" align=\"center\">___________________________________________</font><br1>");
		...
		else if (command.startsWith("Olympiad"))
		{
			...
			final TextBuilder replyMSG = new TextBuilder("<html><title>L2Submission!</title><body><center><br><font color=\"003366\" align=\"center\">___________________________________________</font><img src=L2Submission.gom height=90 width=256><br1><font color=\"003366\" align=\"center\">___________________________________________</font><br1>");
