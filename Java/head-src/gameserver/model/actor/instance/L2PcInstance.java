...
public final class L2PcInstance extends L2PlayableInstance
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		{
			if (Config.TRADE_DROP_PICK_BUY_SELL_ENABLED && getOnlineTime() < Config.PICK_TIME_DISABLE && Config.PICK_TIME_DISABLE!=0)
			{
				sendMessage("You are in Pick Protection Mode for the next " + Config.PICK_TIME_TEXT + " since you have created this char. We apologise for that but it is kind of our own protection. If you believe that you are longer than that time, please restart your character now!");
			}
			else
			{
	...
	private void sendKillerinfos(L2PcInstance pkiller)
	{
		  if (pkiller != null)
	      {
	        String killerinfos = HtmCache.getInstance().getHtm("data/html/mods/Ranking/killerinfo.htm");

	        NpcHtmlMessage htmlMsg = new NpcHtmlMessage(0);
	        if (killerinfos != null)
	        {
	          htmlMsg.setHtml(killerinfos);
	          htmlMsg.replace("%killername%", pkiller.getName());
	          htmlMsg.replace("%killermaxcp%", String.valueOf(pkiller.getMaxCp()));
	          htmlMsg.replace("%killermaxhp%", String.valueOf(pkiller.getMaxHp()));
	          htmlMsg.replace("%killermaxmp%", String.valueOf(pkiller.getMaxMp()));
	          htmlMsg.replace("%killercurrentcp%", String.valueOf((int)pkiller.getCurrentCp()));
	          htmlMsg.replace("%killercurrenthp%", String.valueOf((int)pkiller.getCurrentHp()));
	          htmlMsg.replace("%killercurrentmp%", String.valueOf((int)pkiller.getCurrentMp()));


	            htmlMsg.replace("%pvps%", String.valueOf(pkiller.getPvpKills()));
	            htmlMsg.replace("%pks%", String.valueOf(pkiller.getPkKills()));
	            L2ItemInstance itemInstance = null;

	            L2ItemInstance parmorInstance = pkiller.getInventory().getPaperdollItem(7);

	            L2ItemInstance parmorInstance22 = pkiller.getInventory().getPaperdollItem(14);

	            if ((parmorInstance != null) && (parmorInstance.getEquipSlot() == 7))
	            {
	              itemInstance = parmorInstance;
	              if (itemInstance.isEquipped())
	              {
	                htmlMsg.replace("%weapon%", new StringBuilder().append("<font color=\"09E126\">+ </font>\t").append(String.valueOf(itemInstance.getEnchantLevel())).toString());
	              }

	            }
	            else if ((parmorInstance != null) && (parmorInstance22.getEquipSlot() == 14))
	            {
	              itemInstance = parmorInstance22;
	              if (itemInstance.isEquipped())
	              {
	                htmlMsg.replace("%weapon%", new StringBuilder().append("<font color=\"09E126\">+ </font>\t").append(String.valueOf(itemInstance.getEnchantLevel())).toString());
	              }
	            ...
	            {
	              htmlMsg.replace("%weapon%", "<font color=\"F01111\">No Weapon Equiped</font>");
	            }

	            L2ItemInstance itemInstance111 = null;

	            L2ItemInstance parmorInstance111 = pkiller.getInventory().getPaperdollItem(8);

	            L2ItemInstance parmorInstance222 = pkiller.getInventory().getPaperdollItem(14);

	            if ((parmorInstance111 != null) && (parmorInstance111.getEquipSlot() == 8))
	            {
	              itemInstance111 = parmorInstance111;
	              if ((itemInstance111.isEquipped()) && (!itemInstance111.isItem()))
	              {
	                htmlMsg.replace("%shield%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance111.getEnchantLevel())).toString());
	              }

	            }
	            else if ((parmorInstance222 != null) && (parmorInstance222.getEquipSlot() == 14))
	            {
	              itemInstance111 = parmorInstance222;
	              if ((itemInstance111.isEquipped()) && (!itemInstance111.isItem()))
	              {
	                htmlMsg.replace("%shield%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance111.getEnchantLevel())).toString());
	              }
	            ...
	            {
	              htmlMsg.replace("%shield%", "<font color=\"F01111\">No Shield Equiped</font>");
	            }

	            L2ItemInstance itemInstance1 = null;

	            L2ItemInstance parmorInstance1 = pkiller.getInventory().getPaperdollItem(6);

	            if ((parmorInstance1 != null) && (parmorInstance1.getEquipSlot() == 6))
	            {
	              itemInstance1 = parmorInstance1;
	              if (itemInstance1.isEquipped())
	              {
	                htmlMsg.replace("%helmet%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance1.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%helmet%", "<font color=\"F01111\">No Helmet Equiped</font>");
	            }

	            L2ItemInstance itemInstance3 = null;

	            L2ItemInstance parmorInstance3 = pkiller.getInventory().getPaperdollItem(10);

	            if ((parmorInstance3 != null) && (parmorInstance3.getEquipSlot() == 10))
	            {
	              itemInstance3 = parmorInstance3;

	              if (itemInstance3.isEquipped())
	              {
	                htmlMsg.replace("%chest%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance3.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%chest%", "<font color=\"F01111\">No Chest Equiped</font>");
	            }

	            L2ItemInstance itemInstance4 = null;

	            L2ItemInstance parmorInstance4 = pkiller.getInventory().getPaperdollItem(9);

	            if ((parmorInstance4 != null) && (parmorInstance4.getEquipSlot() == 9))
	            {
	              itemInstance4 = parmorInstance4;
	              if (itemInstance4.isEquipped())
	              {
	                htmlMsg.replace("%gloves%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance4.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%gloves%", "<font color=\"F01111\">No Gloves Equiped</font>");
	            }

	            L2ItemInstance itemInstance5 = null;

	            L2ItemInstance parmorInstance5 = pkiller.getInventory().getPaperdollItem(12);

	            if ((parmorInstance5 != null) && (parmorInstance5.getEquipSlot() == 12))
	            {
	              itemInstance5 = parmorInstance5;
	              if (itemInstance5.isEquipped())
	              {
	                htmlMsg.replace("%boots%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance5.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%boots%", "<font color=\"F01111\">No Boots Equiped</font>");
	            }

	            L2ItemInstance itemInstance6 = null;

	            L2ItemInstance parmorInstance6 = pkiller.getInventory().getPaperdollItem(11);

	            if ((parmorInstance6 != null) && (parmorInstance6.getEquipSlot() == 11))
	            {
	              itemInstance6 = parmorInstance6;
	              if (itemInstance6.isEquipped())
	              {
	                htmlMsg.replace("%legs%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance6.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%legs%", "<font color=\"F01111\">No Legs Equiped</font>");
	            }

	            L2ItemInstance itemInstance7 = null;

	            L2ItemInstance parmorInstance7 = pkiller.getInventory().getPaperdollItem(1);

	            if ((parmorInstance7 != null) && (parmorInstance7.getEquipSlot() == 1))
	            {
	              itemInstance7 = parmorInstance7;
	              if (itemInstance7.isEquipped())
	              {
	                htmlMsg.replace("%lear%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance7.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%lear%", "<font color=\"F01111\">No Right Earing Equiped</font>");
	            }

	            L2ItemInstance itemInstance8 = null;

	            L2ItemInstance parmorInstance8 = pkiller.getInventory().getPaperdollItem(2);

	            if ((parmorInstance8 != null) && (parmorInstance8.getEquipSlot() == 2))
	            {
	              itemInstance8 = parmorInstance8;
	              if (itemInstance8.isEquipped())
	              {
	                htmlMsg.replace("%rear%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance8.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%rear%", "<font color=\"F01111\">No Left Earing Equiped</font>");
	            }

	            L2ItemInstance itemInstance9 = null;

	            L2ItemInstance parmorInstance9 = pkiller.getInventory().getPaperdollItem(4);

	            if ((parmorInstance9 != null) && (parmorInstance9.getEquipSlot() == 4))
	            {
	              itemInstance9 = parmorInstance9;
	              if (itemInstance9.isEquipped())
	              {
	                htmlMsg.replace("%lfinger%", new StringBuilder().append("<font color=\"09E126\">+ </font> ").append(String.valueOf(itemInstance9.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%lfinger%", "<font color=\"F01111\">No Right Ring Equiped</font>");
	            }

	            L2ItemInstance itemInstance10 = null;

	            L2ItemInstance parmorInstance10 = pkiller.getInventory().getPaperdollItem(5);

	            if ((parmorInstance10 != null) && (parmorInstance10.getEquipSlot() == 5))
	            {
	              itemInstance10 = parmorInstance10;
	              if (itemInstance10.isEquipped())
	              {
	                htmlMsg.replace("%rfinger%", new StringBuilder().append("<font color=\"09E126\">+</font>").append(String.valueOf(itemInstance10.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%rfinger%", "<font color=\"F01111\">No Left Ring Equiped</font>");
	            }

	            L2ItemInstance itemInstance11 = null;

	            L2ItemInstance parmorInstance11 = pkiller.getInventory().getPaperdollItem(3);

	            if ((parmorInstance11 != null) && (parmorInstance11.getEquipSlot() == 3))
	            {
	              itemInstance11 = parmorInstance11;
	              if (itemInstance11.isEquipped())
	              {
	                htmlMsg.replace("%neck%", new StringBuilder().append("<font color=\"09E126\">+ </font>").append(String.valueOf(itemInstance11.getEnchantLevel())).toString());
	              }

	            }
	            else
	            {
	              htmlMsg.replace("%neck%", "<font color=\"F01111\">No Necklace Equiped</font>");
	            }
	...
	public boolean doDie(final L2Character killer)
	{
		...
		{
			if(Config.KILLERPANELENABLED)
			{
				sendKillerinfos((L2PcInstance) killer);
			}
			else
			{
				return false;
	...
	private void storeSkill(final L2Skill newSkill, final L2Skill oldSkill, final int newClassIndex)
	{
		...
		try
		{
			...
			{
				//if(oldSkill.getId()!= 9800 && oldSkill.getId()!= 9801 && oldSkill.getId()!= 9802 && oldSkill.getId()!= 9803 && oldSkill.getId()!= 9804 && oldSkill.getId()!= 9805 && oldSkill.getId()!= 9806 && oldSkill.getId()!= 9807 && oldSkill.getId()!= 9808 && oldSkill.getId()!= 9809 && oldSkill.getId()!= 9810 && oldSkill.getId()!= 9811 && oldSkill.getId()!= 9812 && oldSkill.getId()!= 9813 && oldSkill.getId()!= 9814 && oldSkill.getId()!= 9815 && oldSkill.getId()!= 9816 && oldSkill.getId()!= 9817 && oldSkill.getId()!= 9818 && oldSkill.getId()!= 9819 && oldSkill.getId()!= 9820 && )
				//if(oldSkill.getId()< 9800 && oldSkill.getId()>9899 && newSkill.getId()<9800 &&newSkill.getId()>9899)
				//{
		...
		{
			if(newSkill.getId()<9800 || newSkill.getId()>9899)
			{
				if (Config.ENABLE_ALL_EXCEPTIONS)
					e.printStackTrace();
			

				LOGGER.warn("Error could not store char skills at character_skill table on mysql: " + e);
			}
		}
		finally
		{
	...
	{
		if(Config.TRADE_DROP_PICK_BUY_SELL_ENABLED && getOnlineTime() < Config.TRADE_TIME_DISABLE && Config.TRADE_TIME_DISABLE!=0)
		{
			_isInTradeProt = true;
		}
